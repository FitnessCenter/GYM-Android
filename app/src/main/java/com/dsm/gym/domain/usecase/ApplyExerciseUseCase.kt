...
class ApplyExerciseUseCase(private val service : ApplyExerciseService,compositeDisposable: CompositeDisposable) : UseCase<Int, Result<Unit>>(compositeDisposable){
